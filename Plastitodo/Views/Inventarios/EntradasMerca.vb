...
Public Class EntradasMerca
    ...
    Private Sub BGuardardetaentramerca_Click(sender As Object, e As EventArgs) Handles BGuardardetaentramerca.Click
        ...
        consulta.AppendLine($"'{Tcantidad.Text}','{ComboBoxprovee.Text}','{UserName}')")
    ...
    Private Sub BBuscarCodigo_Click(sender As Object, e As EventArgs) Handles BBuscarCodigo.Click
        Try
            Dim conexion As New MySqlConnection(ConnectionString2)
    ...
    Private Sub Buttonlimpiardatos_Click(sender As Object, e As EventArgs) Handles Buttonlimpiardatos.Click
        limpiardatos()
    End Sub
End Class