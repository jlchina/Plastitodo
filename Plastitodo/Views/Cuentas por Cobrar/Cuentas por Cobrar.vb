...
Public Class CuentasCobrar
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Dim newbusquedacliente As New BusquedaCliente2()
        newbusquedacliente.ShowDialog()
        TextBoxRazonSocial.Text = BusquedaCliente2.RazonSocial
        TextBoxEmail.Text = BusquedaCliente2.email
        TextBoxRfc.Text = BusquedaCliente2.rfc
        TextBoxTelefono.Text = BusquedaCliente2.telefono
    End Sub
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles Txtmonto.TextChanged
        ...
        Dim total, saldoanterior, anticipo, monto, abono As Decimal
