...
Public Class Historico_costos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Plastitodo.Historico_costos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHistorico_costos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Historico_costos = New Historico_costos()
        rpt.Site = Me.Site
        Return rpt
    End Function
